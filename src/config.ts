...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://fishergogo.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2024-11-18", // 站点开始运行日期，用于站点统计组件计算运行天数
...
export const profileConfig: ProfileConfig = {
	avatar: "/assets/head.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Fisher",
