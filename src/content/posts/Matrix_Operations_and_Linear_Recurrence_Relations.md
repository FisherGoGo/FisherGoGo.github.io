...
description: "线性递推 - 一个序列 ，如果其第 项可以表示为前 项的线性组合，那么他就是 阶线性递推序列 - 其中 为常数，著名例子就是斐波那契数列 用矩阵表示递推 - 我们要构造一个 状态向量 和 转移矩阵 来实现 - 状态向量…"
tags: ["Math"]
category: "数学"
legacySlug: "Matrix_Operations_and_Linear_Recurrence_Relations"
draft: false
---
# 线性递推
